    ...
    <nav class="navbar header-top fixed-top navbar-expand-lg navbar-dark bg-info">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav animate side-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo site_url('messanger') ?>" title="Cart"><i class="fas fa-envelope"></i> Messanger <i class="fas fa-envelope shortmenu animate"></i></a>
          </li>
		  ...
		  <?php else: ?>
		  <li class="nav-item">
            <a class="nav-link" href="<?php echo site_url('test_api') ?>" title="Leaves"><i class="fas fa-suitcase"></i> Leaves <i class="fas fa-suitcase shortmenu animate"></i></a>
          </li>
		  <?php endif; ?>
		  <li class="nav-item">
        ...
        <ul class="navbar-nav ml-md-auto d-md-flex">
          <li class="nav-item">
            <a class="nav-link" href="javascript:void(0);" style="color:#f5f5f5;"><i class="fas fa-user-circle" style="color:#f5f5f5;"></i> Welcome <?php echo strtoupper($this->session->userdata('username')) ?></a>
          </li>
          <li class="nav-item">
